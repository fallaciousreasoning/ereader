...
export default function BookControls(props: Props) {
    ...
    return <div className={`absolute top-0 bottom-0 left-0 right-0 pointer-events-none gap-10 grid grid-cols-3 text-3xl ${overlay === 'tapzones' ? 'opacity-70' : 'opacity-0'}`}>
